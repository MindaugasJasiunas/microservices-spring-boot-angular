...
export class AuthenticationService {
  ...
  public isUserCourier(token: string): boolean{
    const authorities = (this.jwtHelper.decodeToken(token).authorities as [prop: string]);
    const found = authorities.find(value => value === "courier");
